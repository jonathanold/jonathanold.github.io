...
{{< gallery >}}
  ...
  {{< figure link="/images/clt.gif" caption="Central Limit Theorem in Action" alt="This images shows the Central Limit Theorem in action. We throw a number of dice and record the mean of all these dice 100,000 times. As we increase the number of dice thrown in a single time from 1 to 50, the distribution of the overall means becomes more and more similar to a normal distribution.">}}
